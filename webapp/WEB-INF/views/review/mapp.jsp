...
<p>"37.49722015035048" , "127.02931626635113" ,  "37.49455346636902"  ,  "127.02809846805427"
...
var clickLine = new daum.maps.Polyline({
    ...
    path: [  new daum.maps.LatLng(37.49722015035048, 127.02931626635113),
             new daum.maps.LatLng(37.49455346636902, 127.02809846805427)], // 선을 구성하는 좌표 배열입니다 클릭한 위치를 넣어줍니다
...
var circleOverlay1 = new daum.maps.CustomOverlay({
    ...
    position: new daum.maps.LatLng(37.49722015035048, 127.02931626635113),
    zIndex: 1
});
var circleOverlay2 = new daum.maps.CustomOverlay({
    content: '<span class="dot"></span>',
    position: new daum.maps.LatLng(37.49455346636902, 127.02809846805427),
    zIndex: 1
});

// 지도에 표시합니다
circleOverlay1.setMap(map);
circleOverlay2.setMap(map);
...
if (distance > 0) {
    // 클릭한 지점까지의 그려진 선의 총 거리를 표시할 커스텀 오버레이를 생성합니다
    var distanceOverlay2 = new daum.maps.CustomOverlay({
        content: '<div class="dotOverlay">거리 <span class="number">' + distance + '</span>m</div>',
        position: new daum.maps.LatLng(37.49455346636902, 127.02809846805427),
        yAnchor: 1,
        zIndex: 2
...
// 배열에 추가합니다
dots.push({circle:circleOverlay1, distance: distanceOverlay1});
dots.push({circle:circleOverlay2, distance: distanceOverlay2});
...
showDistance(content, new daum.maps.LatLng(37.49455346636902, 127.02809846805427));
