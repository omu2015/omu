    ...
    <div id="menu_wrap" class="bg_white">
        <div class="option">
            <p>
                ...
                <input type="hidden" value="이태원 맛집" id="keyword" size="15"> 
...
var jsonContentVo =[];
	jsonContentVo = JSON.parse('${contentVo}');
var content= [];
	for(var i=0; i<jsonContentVo.length; i++){
	content[i] = jsonContentVo[i];
	var title = 
	var lat = content[i].latitude;
	var lng = content[i].longitude;
	setMarker(lat, lng);
	var moveLatLon = new daum.maps.LatLng(content[0].latitude,content[0].longitude);
